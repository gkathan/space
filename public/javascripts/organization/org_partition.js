...
var vis = d3.select("#d3container").append("div")
    .attr("class", "chart")
    .style("width", w + "px")
    .style("height", h + "px")
  .append("svg:svg")
...
//d3.json("flare.json", function(root) {
  ...
  var _text = g.append("svg:text")
      .attr("transform", transform)
      .attr("dy", ".35em")
      .style("opacity", function(d) { return d.dx * ky > 12 ? 1 : 0; })
      .text(function(d) { return d.name+" - "+d.employee; })
  _text.append("tspan")
			.style("font-size","7px")
			.attr("dx", "-10em")
			.attr("dy", ".85em")
			.style("opacity", function(d) { return d.dx * ky > 12 ? 1 : 0; })
			.text(function(d) { return d.costcenter+" - "+d.location; })
