...
exports.store = function (filename,collection) {
	...
	_data.contact = config.firereports.contact;
	_data.contactEmail = config.firereports.contactEmail;
	_data.path = _path;
...
/**
 * checks format for firereport upload
 * must be: firereport_<year>-<type>-<number>.xlsx
 * example firereport_2015-week-7.pdf
 * example firereport_2015-month-1.pdf = would be the january report
 */
